...
_lr_signature = 'AND ATOM CDER CHARACTER CIZQ COMMENT CONJ_COLL COUNT_COLL DEC DEF DEFN DISPATCH DIVI FIND_MAP FN FOR GET_VEC IF IGUAL INC INCLUDE_STR INDEXOF_VEC JOIN_STR KEYWORD LDER LIZQ MAYOR MENOR MULT NIL NOT NUMBER OR PDER PIZQ PRINT QUOT QUOTE REM RESET RESTA SPLIT_STR STRING SUMA SWAP VARIABLE WHILEalgoritmo : imprimir\n                    | definition\n                    | expresion\n    expresion : valor\n    definition : DEF VARIABLE valorexpresion : PIZQ operadorMat expresion expresion PDERoperadorMat : SUMA\n                   | RESTA\n                   | MULT\n                   | DIVI\n    imprimir : PRINT valorvalor : NUMBER\n            | VARIABLE\n    '
